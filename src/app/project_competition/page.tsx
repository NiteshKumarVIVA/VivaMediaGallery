    ...
    const visits = [
      {
        ...
        title: "Demo title",
        description:
          "A competition where participants preknkklsent innovative AI solutions for healthcare, focusing on predicting medical conditions using patient data to improve healthcare accessibility.",
      },
      {
